...
using +.
Other example classes where arithmetic operators may be overloaded are Complex Number, Fractional Number, 
Big Integer, etc.
...
See https://www.geeksforgeeks.org/operator-overloading-c/#:~:text=Why%20can%E2%80%99t%20.%20(dot,to%20another%20type. for answers from Stroustrup himself.
...
most of the cases (this behavior is same as copy constructor). See this for more details.
...
4) Any constructor that can be called with a single argument works as a conversion constructor, means it can also
 be used for implicit conversion to the class being constructed.
    #include<iostream> 
    using namespace std;
